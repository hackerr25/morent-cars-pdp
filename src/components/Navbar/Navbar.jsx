...
//     return (
//         <div>
//             <div className="container d-flex justify-content-between align-items-center py-3 px-2">
...
//                     <SearchIcon style={{ marginRight: "10px", position: "absolute", left: "10px", bottom: "8px", color: "#596780" }} />
